...
const stripe =
  ...
  (() => {
    ...
    // // If in development, point to stripe-mock server
    // if (process.env.NODE_ENV === "development") {
    //   stripeOptions.host = "localhost";
    //   stripeOptions.port = 12111;
    //   stripeOptions.protocol = "http";
    // }

    const client = new Stripe(stripeApiKey, stripeOptions)
...
//   namespace Stripe {
//     type DiscriminatedEvent = DiscriminatedEvent.TreasuryReceivedDebitEvent;
...
//        */
//       type Type = "treasury.received_debit.created";
